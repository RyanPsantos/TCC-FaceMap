"""
Django settings for facemap project.
...
SECRET_KEY = 'django-insecure-1=*7y5wv1**mt)!z3@s(+lbn=rga#wp6m-dnj2-v3_a$lbio=3'
...
# Local onde os arquivos estáticos estão durante o desenvolvimento
STATICFILES_DIRS = [
